...
// const seleniumHubHost = process.env.SELENIUM_HUB_HOST || '20.85.138.249';
const seleniumHubHost = process.env.SELENIUM_HUB_HOST || '20.236.235.251';
// const seleniumHubHost = process.env.SELENIUM_HUB_HOST || '52.249.193.85';
